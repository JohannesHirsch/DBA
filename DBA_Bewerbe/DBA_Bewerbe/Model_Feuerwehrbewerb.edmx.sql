...
-- --------------------------------------------------
-- Date Created: 06/03/2016 18:30:50
-- Generated from EDMX file: C:\GitHub\DBA\DBA_Bewerbe\DBA_Bewerbe\Model_Feuerwehrbewerb.edmx
-- --------------------------------------------------

SET QUOTED_IDENTIFIER OFF;
GO
USE [C:\GITHUB\DBA\DBA_BEWERBE\DB_BEWERBE.MDF];
GO
...
CREATE TABLE [dbo].[tTeilnehmendeMannschaftSet] (
    [Id] int IDENTITY(1,1) NOT NULL,
    [Startnummer] nvarchar(100)  NOT NULL,
...
CREATE TABLE [dbo].[tLaufSet] (
    ...
    [tTyp_Kuerzel] nvarchar(100)  NOT NULL,
